...
from input_ops_video import create_input_ops
from util import log
from config_video_conv3d import argparser
...
class Trainer(object):
    ...
    def __init__(self, config, model, dataset):
        ...
        model_hyperparameter_str = '{}_conv_{}_fc_{}_norm_act_{}'.format(
            config.num_d_conv,config.num_d_fc,
            config.d_norm_type, config.output_act_fn)
